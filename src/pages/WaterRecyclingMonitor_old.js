    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 dark:from-gray-950 dark:via-gray-900 dark:to-blue-950 p-4 md:p-8">
      ...
      <GlassSection colors={{ primary: "blue", secondary: "cyan" }} elevation="high">
        <div className="py-8 px-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-3 bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
            💧 Water Recycling System Monitor
          </h1>
      ...
      <GlassCard colors={{ primary: "blue", secondary: "cyan" }}>
        <div className="p-8">
          <label className="block text-lg font-semibold text-gray-800 dark:text-white mb-6">Active System</label>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {systems.map(system => (
              <button
                key={system.id}
                onClick={() => handleSystemChange(system)}
                className={`p-6 rounded-lg text-left transition-all duration-300 backdrop-blur-md border-2 ${
                  selectedSystem?.id === system.id
                    ? "bg-blue-400/30 dark:bg-blue-600/40 border-blue-400 dark:border-blue-500 ring-2 ring-blue-300 dark:ring-blue-400"
                    : "bg-white/20 dark:bg-gray-700/30 border-blue-200/50 dark:border-gray-600/50 hover:border-blue-400 dark:hover:border-blue-400 hover:bg-blue-300/20 dark:hover:bg-blue-700/30"
                }`}
              >
                <div className="font-bold text-lg text-gray-800 dark:text-white">{system.name}</div>
        ...
        <GlassGrid cols={2} colsMd={4} gap={5}>
          <GlassCard colors={{ primary: "blue", secondary: "blue" }}>
            <div className="p-8 text-center">
              <div className="text-sm text-gray-700 dark:text-gray-300">Recycling %</div>
              <div className="text-4xl font-bold text-blue-600 dark:text-blue-400 my-3">{todayMetrics.recyclingPercentage}%</div>
              <p className="text-xs text-gray-600 dark:text-gray-400">today's efficiency</p>
            </div>
          </GlassCard>
          <GlassCard colors={{ primary: "green", secondary: "emerald" }}>
            <div className="p-8 text-center">
              <div className="text-sm text-gray-700 dark:text-gray-300">Recycled Water</div>
              <div className="text-4xl font-bold text-green-600 dark:text-green-400 my-3">{todayMetrics.recycledWater}L</div>
              <p className="text-xs text-gray-600 dark:text-gray-400">reused today</p>
            </div>
          </GlassCard>
          <GlassCard colors={{ primary: "orange", secondary: "amber" }}>
            <div className="p-8 text-center">
              <div className="text-sm text-gray-700 dark:text-gray-300">Fresh Water</div>
              <div className="text-4xl font-bold text-orange-600 dark:text-orange-400 my-3">{todayMetrics.freshWaterUsed}L</div>
              <p className="text-xs text-gray-600 dark:text-gray-400">added today</p>
            </div>
          </GlassCard>
          <GlassCard colors={{ primary: "purple", secondary: "violet" }}>
            <div className="p-8 text-center">
              <div className="text-sm text-gray-700 dark:text-gray-300">Efficiency Score</div>
              <div className="text-4xl font-bold text-purple-600 dark:text-purple-400 my-3">{todayMetrics.efficiency}/100</div>
              <p className="text-xs text-gray-600 dark:text-gray-400">system performance</p>
            </div>
          </GlassCard>
        </GlassGrid>
      )}
      ...
      <GlassSection colors={{ primary: "blue", secondary: "cyan" }}>
        <div className="overflow-hidden">
          ...
          {activeTab === "overview" && todayMetrics && (
            <div>
              <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-8">Daily Summary - {selectedSystem.name}</h3>

              <div className="grid md:grid-cols-2 gap-8">
                {/* Water Flow */}
                <GlassCard colors={{ primary: "blue", secondary: "cyan" }}>
                  <div className="p-8">
                    <h4 className="font-bold text-xl text-blue-700 dark:text-blue-300 mb-6">💧 Water Flow (Daily)</h4>
                    
                    <div className="space-y-6">
                      <div>
                        <div className="flex justify-between items-center mb-3">
                          <span className="text-gray-700 dark:text-gray-300 font-medium">Inflow</span>
                          <span className="text-blue-700 dark:text-blue-300 font-bold text-lg">{todayMetrics.totalInflow} L</span>
                        </div>
                      ...
                      <div>
                        <div className="flex justify-between items-center mb-3">
                          <span className="text-gray-700 dark:text-gray-300 font-medium">Recycled</span>
                          <span className="text-green-700 dark:text-green-300 font-bold text-lg">{todayMetrics.recycledWater} L</span>
                        </div>
                        <div className="w-full bg-gray-300 dark:bg-gray-700 rounded-full h-4">
                          <div 
